...
La241c:	; 800A241C
800A241C	addu   s6, zero, zero
800A2420	blez   s4, La27ec [$800a27ec]
800A2424	addu   s2, zero, zero
800A2428	lui    t1, $800f
800A242C	addiu  t1, t1, $6b94

La2430:	; 800A2430
800A2430	lui    at, $800f
800A2434	sh     s2, $7dba(at)
800A2438	lbu    v1, $0000(t1)
800A243C	lui    at, $800f
800A2440	addu   at, at, s2
800A2444	lbu    v0, $6b9b(at)
800A2448	nop
800A244C	beq    v1, v0, La27dc [$800a27dc]
800A2450	addu   t0, zero, zero
...
if (T0 != 40)
{
    ...
    800A24D0	sll    v0, s1, $01
    800A24D4	addu   v0, v0, s1
    800A24D8	sll    v0, v0, $02
    800A24DC	addu   v0, v0, s1
    800A24E0	sll    v1, v0, $03
    800A24E4	lui    at, $8010
    800A24E8	addu   at, at, v1
    800A24EC	lb     v0, $83e8(at)
    800A24F0	nop
    800A24F4	beq    v0, s7, La27ec [$800a27ec]
    800A24F8	nop
    800A24FC	blez   s2, La2520 [$800a2520]
    800A2500	slti   v0, s2, $0005
    800A2504	lui    at, $8010

    La2508:	; 800A2508
    800A2508	addu   at, at, v1
    800A250C	lw     v0, $83e0(at)
    800A2510	nop
    ...
    800A2524	sll    v0, s1, $04
    800A2528	addu   v0, v0, s1
    800A252C	sll    v0, v0, $02
    800A2530	lui    at, $800f
    800A2534	addu   at, at, v0
    800A2538	lhu    v0, $5bba(at)
    800A253C	nop
    800A2540	bne    v0, zero, La25b4 [$800a25b4]
    800A2544	addiu  v1, s5, $0206
    800A2548	sll    v0, s1, $03
    800A254C	addu   v0, v0, v1
    [V0 + 0] = w(w[S5 + 0]);
    [V0 + 4] = h(h[S5 + 4]);
    ...
    800A25B8	addu   a0, s1, zero

    La25bc:	; 800A25BC
    800A25BC	lui    v0, $800f
    800A25C0	lb     v0, $692f(v0)
    800A25C4	nop
    800A25C8	bne    v0, s7, La2710 [$800a2710]
    800A25CC	addu   a3, zero, zero
    800A25D0	slti   v0, s1, $0004
    800A25D4	bne    v0, zero, La2650 [$800a2650]
    800A25D8	addu   a0, zero, zero
    800A25DC	sll    v0, s1, $04
    800A25E0	addu   v0, v0, s1
    800A25E4	sll    v1, s1, $01
    800A25E8	addu   v1, v1, s1
    800A25EC	sll    v1, v1, $02
    800A25F0	addu   v1, v1, s1
    800A25F4	sll    v1, v1, $03
    800A25F8	sll    v0, v0, $02
    800A25FC	lui    at, $8010
    800A2600	addu   at, at, v1

    La2604:	; 800A2604
    800A2604	lw     a1, $83e0(at)
    800A2608	lui    at, $800f
    800A260C	addu   at, at, v0
    800A2610	lw     a2, $5bf0(at)
    800A2614	andi   v1, a1, $0080
    800A2618	beq    v1, zero, La2634 [$800a2634]
    800A261C	lui    v0, $0080
    800A2620	lhu    v0, $009a(a2)
    800A2624	nop
    800A2628	andi   v0, v0, $0001
    800A262C	sltiu  a3, v0, $0001
    800A2630	lui    v0, $0080

    La2634:	; 800A2634
    800A2634	and    v0, a1, v0
    800A2638	beq    v0, zero, La2644 [$800a2644]
    800A263C	nop
    800A2640	ori    a3, zero, $0001

    La2644:	; 800A2644
    800A2644	beq    a3, zero, La2654 [$800a2654]
    800A2648	sll    v0, s1, $01
    800A264C	lhu    a0, $0094(a2)

    La2650:	; 800A2650
    800A2650	sll    v0, s1, $01

    La2654:	; 800A2654
    800A2654	addu   v0, v0, s1
    800A2658	sll    v0, v0, $02
    800A265C	addu   v0, v0, s1
    800A2660	sll    a1, v0, $03
    800A2664	lui    at, $8010
    800A2668	addu   at, at, a1
    800A266C	lw     v0, $83e0(at)
    800A2670	lui    v1, $0040
    800A2674	and    v0, v0, v1
    ...
    800A268C	nop
    800A2690	sw     zero, $0010(sp)
    800A2694	addu   a0, s1, zero
    800A2698	ori    a1, zero, $0002
    800A269C	ori    a2, zero, $0020
    800A26A0	jal    funca3e98 [$800a3e98]
    800A26A4	addu   a3, v0, zero
    800A26A8	j      La27cc [$800a27cc]
    800A26AC	nop

    La26b0:	; 800A26B0
    800A26B0	lui    at, $8010
    800A26B4	addu   at, at, a1
    800A26B8	lw     v0, $83e4(at)
    800A26BC	nop

    La26c0:	; 800A26C0
    800A26C0	andi   v0, v0, $0010
    800A26C4	beq    v0, zero, La27cc [$800a27cc]
    800A26C8	nop
    800A26CC	jal    funca32c0 [$800a32c0]
    800A26D0	ori    a0, zero, $0001
    ...
    V1 = bu[800f6b96];
    V0 = bu[800f6b9d];
    800A26F8	bne    v1, v0, La27cc [$800a27cc]
    800A26FC	ori    s6, zero, $0001
    800A2700	jal    funca22c0 [$800a22c0]
    800A2704	addu   a0, s1, zero
    800A2708	j      La27cc [$800a27cc]
    800A270C	ori    s6, zero, $0001
    ...
    La27bc:	; 800A27BC
    800A27BC	lui    a0, $800f
    800A27C0	addiu  a0, a0, $692c
    800A27C4	jal    funca1798 [$800a1798]
    800A27C8	nop
...
800A27F0	nop
800A27F4	bne    s2, s4, La2808 [$800a2808]
800A27F8	xor    v0, s2, s4
800A27FC	jal    funca22c0 [$800a22c0]
800A2800	addiu  a0, zero, $ffff (=-$1)
800A2804	xor    v0, s2, s4
                ...
                if (A3 != 200)
                {
                    ...
                    if (S1 != -1)
                    {
                        ...
                        else
                        {
                            ...
                            A0 = 800f692c;
                            funca1798; // main damage function?
                        }
...
if (unit_id != -1)
{
    ...
    A0 = 0;
    loopa22f4:	; 800A22F4
        if (bu[800F6934 + A0 * 8] == 6 && b[800F6934 + A0 * 8 + 2] != unit_id)
        {
            break;
        }
    ...
    if (A0 == 40)
    {
        V0 = bu[800F5BE2 + unit_id * 44]
        V0 = V0 + 1;
        [800F5BE2 + unit_id * 44] = b(V0);
