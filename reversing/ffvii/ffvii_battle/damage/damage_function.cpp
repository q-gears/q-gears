...
////////////////////////////////
// funcb1218
V1 = 800f5bb8 + A0 * 44 + 20;

800B122C	addu   v0, v0, v1
800B1230	addu   v0, v0, a2
800B1234	lb     v1, $0000(v0)
800B1238	nop
800B123C	mult   a1, v1
800B1240	mflo   v1
800B1244	lui    v0, $51eb
800B1248	ori    v0, v0, $851f
800B124C	mult   v1, v0
800B1250	sra    v1, v1, $1f
800B1254	mfhi   a3
800B1258	sra    v0, a3, $05
800B125C	subu   v0, v0, v1
