...
V0 = w[V0 + 1c];
index = bu[V0 + 8];
S3 = w[V0 + 10 + index * 4] - b[part_data + 13] * 4;
...
if( number_of_quads != 0 )
{
    loopb5a18:	; 800B5A18
        ...
        vertex2 = h[mesh_data + 2];
        vertex3 = h[mesh_data + 4];
        vertex4 = h[mesh_data + 6];

        if( ( bu[mesh_data + 15] & 02 ) == 0 )
        {
            SXY0 = w[800711a8 + vertex1 * 4];
            SXY1 = w[800711a8 + vertex2 * 4];
            SXY2 = w[800711a8 + vertex3 * 4];
        ...
        [A2 +  8] = w(w[800711a8 + vertex1 * 4]);
        [A2 + 10] = w(w[800711a8 + vertex2 * 4]);
        [A2 + 18] = w(w[800711a8 + vertex3 * 4]);
        [A2 + 20] = w(w[800711a8 + vertex4 * 4]);

        A3 = S3 + (((w[80070520 + vertex1 * 4] + w[80070520 + vertex2 * 4] + w[80070520 + vertex3 * 4] + w[80070520 + vertex4 * 4]) >> 4) << 2);
...
// quads
number_of_quads = hu[part_data + 2];
if( number_of_quads != 0 )
{
    T6 = 0;
    loopbb7ec:	; 800BB7EC
        ...
        A0 = w[80070520 + vertex1 * 4] + w[80070520 + vertex2 * 4] + w[80070520 + vertex3 * 4] + w[80070520 + vertex4 * 4];
        ...
        if( A0 <= 3fffffff )
        {
            ...
            {
                SXY0 = w[800711a8 + vertex1 * 4];
                SXY1 = w[800711a8 + vertex3 * 4];
                SXY2 = w[800711a8 + vertex2 * 4];
            ...
            [T5 + 08] = w(w[800711a8 + vertex1 * 4]);
            [T5 + 10] = w(w[800711a8 + vertex2 * 4]);
            [T5 + 18] = w(w[800711a8 + vertex3 * 4]);
            [T5 + 20] = w(w[800711a8 + vertex4 * 4]);
