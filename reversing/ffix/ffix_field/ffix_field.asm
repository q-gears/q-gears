...
800C2924	sw     s2, $0020(sp)
800C2928	addu   s2, a0, zero
800C292C	sw     s6, $0030(sp)
800C2930	addu   s6, a1, zero
800C2934	sw     s4, $0028(sp)
800C2938	addu   s4, a2, zero
800C293C	sw     s5, $002c(sp)
800C2940	addu   s5, a3, zero
800C2944	slti   v0, s5, $0009
800C2948	sw     ra, $0034(sp)
800C294C	sw     s3, $0024(sp)
800C2950	sw     s1, $001c(sp)
800C2954	beq    v0, zero, Lc2ac4 [$800c2ac4]
800C2958	sw     s0, $0018(sp)
800C295C	lui    v0, $800d
800C2960	addiu  s1, v0, $9df0 (=-$6210)
800C2964	lw     a2, $0000(s6)
800C2968	lw     a0, $0008(s1)
800C296C	addu   a3, s4, zero
800C2970	sw     a2, $0010(sp)
800C2974	lh     a1, $0004(a2)
800C2978	lw     v0, $001c(s1)
800C297C	sll    a1, a1, $05
800C2980	jal    funcc4b30 [$800c4b30]
800C2984	addu   a1, v0, a1
800C2988	andi   v0, v0, $00ff

Lc298c:	; 800C298C
800C298C	beq    v0, zero, Lc29cc [$800c29cc]
800C2990	addiu  v0, zero, $0001
800C2994	j      Lc2ac8 [$800c2ac8]
800C2998	nop

loopc299c:	; 800C299C
800C299C	addu   v0, v0, v1
800C29A0	lw     v1, $0010(s3)
800C29A4	sll    v0, v0, $03
800C29A8	addu   v1, v1, v0
800C29AC	sw     v1, $0014(sp)
800C29B0	lhu    v0, $0004(v1)
800C29B4	nop

Lc29b8:	; 800C29B8
800C29B8	sh     v0, $0004(s2)

loopc29bc:	; 800C29BC
800C29BC	lw     v1, $0014(sp)
800C29C0	addiu  v0, zero, $0001
800C29C4	j      Lc2ac8 [$800c2ac8]
800C29C8	sw     v1, $0000(s6)

Lc29cc:	; 800C29CC
800C29CC	addu   s0, zero, zero
800C29D0	addu   s3, s1, zero
800C29D4	addu   a0, s2, zero

loopc29d8:	; 800C29D8
800C29D8	andi   s1, s0, $ffff
800C29DC	lw     a1, $0010(sp)

Lc29e0:	; 800C29E0
800C29E0	jal    field_get_next_walkmesh_triangle_address [$800c1f98]
800C29E4	addu   a2, s1, zero
800C29E8	beq    v0, zero, Lc2a44 [$800c2a44]
800C29EC	sw     v0, $0014(sp)
800C29F0	addu   a2, v0, zero
800C29F4	addu   a3, s4, zero
800C29F8	lw     a0, $0008(s3)
800C29FC	lh     a1, $0004(a2)
800C2A00	lw     v0, $001c(s3)
800C2A04	sll    a1, a1, $05
800C2A08	jal    funcc4b30 [$800c4b30]
800C2A0C	addu   a1, v0, a1
800C2A10	andi   v0, v0, $00ff
800C2A14	beq    v0, zero, Lc2a44 [$800c2a44]
800C2A18	sll    v1, s1, $01
800C2A1C	lw     v0, $0010(sp)
800C2A20	nop
800C2A24	addu   v0, v0, v1
800C2A28	lhu    v0, $0018(v0)
800C2A2C	nop
800C2A30	sh     v0, $0006(s2)
800C2A34	sll    v0, v0, $10
800C2A38	sra    v1, v0, $10
800C2A3C	bgez   v1, loopc299c [$800c299c]
800C2A40	sll    v0, v1, $02

Lc2a44:	; 800C2A44
800C2A44	addiu  s0, s0, $0001
800C2A48	andi   v0, s0, $ffff
800C2A4C	sltiu  v0, v0, $0003
800C2A50	bne    v0, zero, loopc29d8 [$800c29d8]
800C2A54	addu   a0, s2, zero
800C2A58	addu   s0, zero, zero

loopc2a5c:	; 800C2A5C
800C2A5C	lw     a1, $0010(sp)
800C2A60	jal    field_get_next_walkmesh_triangle_address [$800c1f98]
800C2A64	andi   a2, s0, $ffff
800C2A68	addu   v1, v0, zero
800C2A6C	beq    v1, zero, Lc2ab0 [$800c2ab0]
800C2A70	sw     v1, $0014(sp)
800C2A74	lhu    a0, $0000(v1)
800C2A78	nop
800C2A7C	andi   v0, a0, $0080
800C2A80	bne    v0, zero, Lc2ab0 [$800c2ab0]
800C2A84	ori    v0, a0, $0080
800C2A88	sh     v0, $0000(v1)
800C2A8C	addu   a0, s2, zero
800C2A90	addiu  a1, sp, $0014
800C2A94	addu   a2, s4, zero
800C2A98	jal    funcc2920 [$800c2920]
800C2A9C	addiu  a3, s5, $0001
800C2AA0	andi   v0, v0, $ffff
800C2AA4	addiu  v1, zero, $0001
800C2AA8	beq    v0, v1, loopc29bc [$800c29bc]
800C2AAC	nop

Lc2ab0:	; 800C2AB0
800C2AB0	addiu  s0, s0, $0001
800C2AB4	andi   v0, s0, $ffff
800C2AB8	sltiu  v0, v0, $0003
800C2ABC	bne    v0, zero, loopc2a5c [$800c2a5c]
800C2AC0	addu   a0, s2, zero

Lc2ac4:	; 800C2AC4
800C2AC4	addu   v0, zero, zero

Lc2ac8:	; 800C2AC8
800C2AC8	lw     ra, $0034(sp)
800C2ACC	lw     s6, $0030(sp)
800C2AD0	lw     s5, $002c(sp)
800C2AD4	lw     s4, $0028(sp)
800C2AD8	lw     s3, $0024(sp)
800C2ADC	lw     s2, $0020(sp)
800C2AE0	lw     s1, $001c(sp)
800C2AE4	lw     s0, $0018(sp)
800C2AE8	jr     ra 
800C2AEC	addiu  sp, sp, $0038
