...
static inline void execI()
{
	...
	if(_upse_breakpoint_callback_f != NULL && upse_r3000_cpu_regs.pc == _upse_breakpoint_address)
	{
		_upse_breakpoint_callback_f(sampcount, _upse_breakpoint_cb_user_data);
	}
