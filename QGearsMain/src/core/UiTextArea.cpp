...
UiTextArea::SetText( const Ogre::UTFString& text )
{
    ...
    LOG_ERROR("printing string: " + text);
    ...
    if( m_Font != NULL )
    {
        ...
        if( language != "" )
        {
            if( TextManager::getSingleton().GetLanguage() != language )
            {
                ...
                LOG_ERROR("With font: " + m_Font->GetName());
            }
        }
    }
...
UiTextArea::UpdateGeometry()
{
    ...
    for( ; ( i < m_TextLimit ) && ( i < m_Text.size() ); ++i )
    {
        ...
        LOG_ERROR( "red = " + Ogre::StringConverter::toString( colour.r ) + "." );
        LOG_ERROR( "green = " + Ogre::StringConverter::toString( colour.g ) + "." );
        LOG_ERROR( "blue = " + Ogre::StringConverter::toString( colour.b ) + "." );
